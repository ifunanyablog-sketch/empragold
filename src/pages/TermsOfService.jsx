  ...
  return (
    <div className="bg-white text-[#C9A227] min-h-screen pt-24 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="my-8">
          <h1 className="text-4xl font-serif font-bold text-[#C9A227] mb-2">Terms of Service</h1>
          <p className="text-xs text-[#9A7B1C] font-semibold">Effective Date: January 2026</p>
        </div>
        ...
        <div className="bg-white border border-[#C9A227]/30 rounded-2xl p-8 space-y-6 text-xs text-[#C9A227]/90 leading-relaxed font-normal shadow-md">
          <section className="space-y-2">
            <h2 className="text-lg font-serif font-bold text-[#C9A227]">1. Brokerage Representation</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-serif font-bold text-[#C9A227]">2. Off-Market Dossiers</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-serif font-bold text-[#C9A227]">3. Intellectual Property</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-serif font-bold text-[#C9A227]">4. Governing Law</h2>
            <p>
