  ...
  return (
    <div className="bg-[#0F0F10] text-gray-100 min-h-screen pt-24 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="my-8">
          <h1 className="text-4xl font-serif font-bold text-white mb-2">Privacy & NDA Policy</h1>
          <p className="text-xs text-[#C9A227]">Last updated: January 2026</p>
        </div>

        <div className="bg-[#1A1A1D] border border-white/10 rounded-2xl p-8 space-y-6 text-xs text-gray-300 leading-relaxed">
          <section className="space-y-2">
            <h2 className="text-lg font-serif font-bold text-white">1. Commitment to Client Anonymity</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-serif font-bold text-white">2. Data Collection & Usage</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-serif font-bold text-white">3. Third-Party Sharing</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-serif font-bold text-white">4. Cookies & Digital Tracking</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-serif font-bold text-white">5. Contact Data Officer</h2>
            <p>
              For privacy inquiries, please contact our Legal Counsel at <span className="text-[#C9A227]">privacy@empragold.com</span>.
            </p>
          </section>
        </div>
      </div>
